...
public class InspectAviaTicketTest {
  ...
  @Test
  public void inspectAviaTicketTest() throws InterruptedException {
    ...
    driver.findElement(By.xpath("//div[2]/div[2]/button/span/span")).click();
    {
      WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
      wait.until(ExpectedConditions.presenceOfElementLocated(
          By.xpath("//div[4]/div/div[2]/div/div/div/div/div[2]/div/div/div/div/div/div/div")));
    }
    Thread.sleep(1000);
    driver.findElement(By.xpath("//div[4]/div/div[2]/div/div/div/div/div[2]/div/div/div/div/div/div/div")).click();
    {
      WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
      wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[2]/div/div/div/div[2]/h2")));
    }
    {
      List<WebElement> elements = driver.findElements(By.xpath("//div[2]/div/div/div/div[2]/h2"));
    ...
    }
    {
      List<WebElement> elements = driver.findElements(By.xpath(
          "//div/div[3]/div/div[2]/div/div/div/div[2]/div/div/div/div[1]/div[2]/div[1]/div[2]/div/div[1]/div[1]/div[2]/p"));
      assert (elements.size() > 0);
